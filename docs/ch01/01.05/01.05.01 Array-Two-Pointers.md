...
int Solution(const std::string &str)
{
    ...
    while (left < right)
    {
        if (!std::isalpha(str[left]))
        {
            left += 1;
            continue;
        }

        if (!std::isalpha(str[right]))
        {
            right -= 1;
            continue;
        }
...
int Solution(const std::array<int, 9> &arr)
{
    int left = 0;
...
int main(int argc, char *argv[])
{
    ...
    std::array<int, 9> arr = {1, 8, 6, 2, 5, 4, 8, 3, 7};
...
int Solution(std::array<int, 3> &arr1,
             std::array<int, 5> &arr2)
{
    ...
    while (left1 < arr1.size() && left2 < arr2.size())
    {
        if (arr1[left1] == arr2[left2])
        {
            if (std::find(ans.begin(), ans.end(), arr1[left1]) == ans.end())
            {
...
int main(int argc, char *argv[])
{
    ...
    std::array<int, 3> arr1 = {4, 9, 5};
    std::array<int, 5> arr2 = {9, 4, 9, 8, 4};
    int dst = Solution(arr1, arr2);
