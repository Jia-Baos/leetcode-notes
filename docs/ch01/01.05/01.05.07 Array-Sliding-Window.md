...
int Solution(std::array<int, 8> &arr)
{
    int k = 3;
    int threshold = 4;
    int ans = 0;
...
{
    std::array<int, 8> arr = {2, 2, 2, 2, 5, 5, 5, 8};
...
int main(int argc, char *argv[])
{
    std::array<int, 6> arr = {2, 3, 1, 2, 4, 3};
